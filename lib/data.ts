export const PROFILE = {
    ...
    social: {
        ...
        facebook: "https://www.facebook.com/thinhxdev",
        email: "mailto:ngothinh.2003.work@gmail.com",
        phone: "+84 779 198 539",
    },
    about: "Backend Software Engineer specializing in the .NET ecosystem and ASP.NET Core. I focus on building maintainable, scalable systems with strong integration of AI-assisted development and AWS cloud technologies. With a solid foundation in DevOps practices and secondary experience in Java enterprise development, my long-term career direction is oriented toward Cloud and Solution Architecture.",
    skills: {
        primary: ["C#", ".NET 8/Core", "ASP.NET Core Web API", "Entity Framework"],
        cloudDevops: ["AWS", "Docker", "Cloudflare", "Redis", "CI/CD"],
        ai: ["AI-assisted Development", "AI Integration", "Prompt Engineering"],
        secondary: ["Java", "Spring Boot", "React", "TypeScript", "PostgreSQL", "SQL Server"],
        engineering: ["Git", "SVN", "MSTest", "JUnit", "Clean Architecture", "Unit Testing"],
        database: ["SQL Server", "Azure SQL", "PostgreSQL", "Entity Modeling"],
        frontend: ["React", "TypeScript", "Vite", "Tailwind CSS", "WPF", "Windows Forms"],
        tools: ["Visual Studio", "IntelliJ IDEA", "Postman", "Clean Architecture"],
        process: ["Specification Analysis", "Daily Reporting", "Issue Escalation", "Code Review"],
    ...
    experience: [
        {
            ...
            summary: "Customer software development project from Japan providing in-vehicle information services. The system delivers connected vehicle services requiring high reliability and integration across multiple technology stacks.",
            responsibilities: [
                "Developed and maintained backend services utilizing both .NET and Java technology stacks.",
                "Implemented ASP.NET features ensuring strict adherence to Japanese customer specifications and business logic.",
                "Ensured software quality by writing and executing unit tests with MSTest and JUnit.",
                "Collaborated with project stakeholders using SVN and Git for version control and CI/CD pipelines.",
                "Supported system debugging, performance optimization, and cross-team issue escalation."
            ],
            technologies: ["ASP.NET", ".NET", "Java", "AWS", "MSTest", "JUnit", "SVN", "Git"]
        }
    ],
    education: [
        {
...
export const PROJECTS = [
    {
        id: 1,
        category: "real",
        title: "GBOOK - In-Vehicle Information Service",
...
export const CERTIFICATIONS = [
    {
        ...
        issuer: "Microsoft",
        date: "08/2026",
        link: "https://learn.microsoft.com/api/credentials/share/en-us/NgoPhuocThinh/EA5647A13D5462E1?sharingId=851C2DE0BD7D7674",
        tier: "Premium",
    },
    {
        id: 2,
